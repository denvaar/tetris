...
describe('writeScreen', () => {
  it('calls `process.stdout.write` with expected ASCII text argument', () => {
    const diff: ScreenInfo = {
      ...
      '3,2': {color: colors.red.normal, value: 'B'},
      '3,3': {color: colors.red.normal, value: 'c'},
      '5,4': {color: colors.red.normal, value: 'Q'},
    ...
    expect(spy).toHaveBeenCalledWith(
      '\x1b[2;2Ha\x1b[2;3H\x1b[38;5;196mB\x1b[3;3Hc\x1b[4;5HQ\x1b[6;5H ' +
        colors.reset,
    );
  });
});
